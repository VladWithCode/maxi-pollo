...
var PrivateAPIController = (function () {
    ...
    PrivateAPIController.prototype.toggleSaleAvailability = function (req, res, next) {
    ...
    PrivateAPIController.prototype.changePass = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, userId, newPass, prevPass, user, passValid, err_11;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, userId = _a.userId, newPass = _a.newPass, prevPass = _a.prevPass;
